...
class CameraViewController: UIViewController {
    ...
    func addFavorite(sender: UIButton){
        ...
        //RouteSchedulesStore.updateFavorite(cameraItem.cameraId, newValue: true)
    }
    ...
    func removeFavorite(sender: UIButton){
        ...
        //RouteSchedulesStore.updateFavorite(cameraItem.cameraId, newValue: false)
    }
}
