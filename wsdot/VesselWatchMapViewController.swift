//
//  VesselWatchMapViewController.swift
//  WSDOT
//
...
class VesselWatchMapViewController: UIViewController, CLLocationManagerDelegate, GMUClusterRendererDelegate {
    ...
    override func loadView() {
        ...
        var lat = UserDefaults.standard.double(forKey: UserDefaultsKeys.vesselWatchMapLat)
        var lon = UserDefaults.standard.double(forKey: UserDefaultsKeys.vesselWatchMapLon)
        var zoom = UserDefaults.standard.float(forKey: UserDefaultsKeys.vesselWatchMapZoom)
